...
txt_1 = tk.Entry(root, font="Courier 40 bold", justify='right')
txt_1.grid(row=0, column=0, columnspan=5, sticky='NESW')

btn1 = tk.Button(root, text="New project", font=font_buttons, command=pyt_new_file)
btn1.grid(row=1, column=0, columnspan=2, sticky='NESW')

btn2 = tk.Button(root, text="New dir", font=font_buttons, command=pyt_new_dir)
btn2.grid(row=1, column=3, columnspan=2, sticky='NESW')

btn_3 = tk.Button(root, text="NEW", font=font_buttons, command=lambda: txt_1.insert(tk.END, "new"))
btn_3.grid(row=1, column=2, sticky='NESW')


btn_c = tk.Button(root, text="clear", font=font_buttons, command=lambda: txt_1.delete(0, tk.END))
